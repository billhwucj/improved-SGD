...
# dir_list = ["baseline_fast", "baseline_slow"]
# dir_list = ["brightness_fast", "brightness_slow"]
# dir_list = ["opacity_fast", "opacity_slow"]
# dir_list = ["original_fast", "original_slow", "size_fast", "size_slow"]

# dir_list = ["size_fast"]

dir_list = ["baseline_fast", "baseline_slow", "original_fast", "original_slow", "size_fast", "size_slow", 
            "opacity_fast", "opacity_slow", "brightness_fast", "brightness_slow"]

starting_time = 1  # Replace with your start value
ending_time = 62  # Replace with your end value
